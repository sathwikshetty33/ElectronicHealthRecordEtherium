...
urlpatterns = [
    ...
    path('hospital-dahboard/',HospitalDashboard.as_view(),name='doc-dash'),
    path('patient-dahboard/',PatientDashboard.as_view(),name='doc-dash'),
    path('doctor-dahboard/',DoctorDashboard.as_view(),name='doc-dash'),
