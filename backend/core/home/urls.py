...
urlpatterns = [
    ...
    path('hospital-dahboard/<int:id>',HospitalDashboard.as_view(),name='doc-dash'),
    path('patient-dahboard/<int:id>',PatientDashboard.as_view(),name='doc-dash'),
    path('doctor-dahboard/<int:id>',DoctorDashboard.as_view(),name='doc-dash'),
